...
if test -f "$FILE"; then
  ...
  apt-get update && apt-get install -y python-dev && apt-get install -y gcc && apt-get install -y build-essential && apt-get install -y build-essential && apt-get install -y libffi-dev && apt-get install -y libssl-dev
